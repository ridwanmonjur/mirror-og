            ...
            try {
                ...
                foreach ($joinList as $join) {
                    foreach ($join->members as $member) {
                        ...
                        if ($member->user->mail) Mail::to($member->user->email)->send($mailInvocation);
                    }
                }
                ...
                foreach ($joinList as $join) {
                    ...
                    if ($join->eventDetails->user->email) Mail::to($join->eventDetails->user->email)->send($mailInvocation);
                }
