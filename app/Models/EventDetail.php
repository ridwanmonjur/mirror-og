...
class EventDetail extends Model
{
    ...
    private static function destroyEventBanner($file)
    {
    ...
    public static function findEventWithTypeTierGameAndThrowError($userId, $id): EventDetail
    {
        $event = self::with('type','tier','game')
            ->find($id);
