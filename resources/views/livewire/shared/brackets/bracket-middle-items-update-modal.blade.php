<div class="modal fade" id="middleMatchModal" tabindex="-1" aria-labelledby="middleMatchModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="middleMatchModalLabel">Middle Match</h5>
