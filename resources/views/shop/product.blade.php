            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    @if (isset($product->categories) && isset($product->categories[0]))
                        <li class="breadcrumb-item"><a href="{{'/shop' . '/'. $product->categories[0]->slug}}" class="text-decoration-none">{{$product->categories[0]->name}}</a></li>
                    @endif
                            ...
                            @if ($product->images)
                                <div class="carousel-inner">
                                    @foreach (json_decode($product->images, true) as $index => $image)
                                        <div class="carousel-item  border border-light {{ $index === 0 ? 'active' : '' }}">
                                ...
                                <button class="carousel-control-prev bg-secondary bg-opacity-75 rounded-circle border border-white border-2 position-absolute top-50 translate-middle-y" 
                                ...
                                <button class="carousel-control-next bg-secondary bg-opacity-75 rounded-circle border border-white border-2  position-absolute top-50 translate-middle-y" 
                ...
                <div class="col-lg-9 col-12">
                    <div class="product-info bg-white border border-light rounded p-4">
                        ...
                        <div class="price-section mb-2">
                            ...
                            <span class="zms_price h3 text-warning fw-bold">RM {{ $product->price }}</span>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="bg-light border-secondary border p-3 rounded">
                                ...
                                <svg width="16" height="16" fill="currentColor" class="text-warning me-2" viewBox="0 0 16 16">
                        ...
                        <div class="mb-4">
                            <div class="d-inline-flex flex-wrap gap-2">
                                @foreach($product->categories as $category)
                                    <a href="{{ '/shop'. '/' . $category->slug }}" class="badge bg-secondary text-white text-decoration-none">
                                        {{ $category->name }}
                                    </a>
                                @endforeach
                            </div>
                                ...
                                <div class="btn-addcart-product-detail">
                                    @if ($product->quantity > 0)
                                        <form action="{{ route('cart.store', $product) }}" method="POST" class="text-center mx-auto w-75">
                                            {{ csrf_field() }}
                                            <button type="submit" class="btn btn-warning   px-5 w-100 text-dark fw-bold rounded-pill">
