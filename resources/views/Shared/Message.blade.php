...
<body id="app">
    ...
    <div id="chat-parent-component" class="app-container row"
        >
        ...
        <div class="sidebar col-12 col-lg-5 col-xl-4 m-0 p-0" >
            ...
            <div class="chat-list" id="room-component">
                    <div v-for="room in oldRooms" :key="room.id" v-bind:data-identity-for-read="room.id" v-on:click="currentRoom = room?.id" :class="{'chat-item': true, 'bg-primary' : currentRoom == room?.id }">
                        <template v-if="room?.otherRoomMember?.userBanner != null">
                            <img {!! trustedBladeHandleImageFailure() !!} v-bind:src="'/storage/' + room?.otherRoomMember?.userBanner" width="50" height="50"
                        ...
                        <div class="chat-info">
                            ...
                            <p class="status my-0">
                                <span v-html="formatDate(room.otherRoomMember?.updated_at)"></span>
        ...
        <div id="chat-component" class="chat-container position-relative col-12 d-flex col-lg-7 col-xl-8 m-0 p-0" style="overflow: hidden;">
            <div class="chat-header w-100">
                <h2 class="chat-user-name my-0" v-text="currentRoomObject?.otherRoomMember?.name ?? 'Start a chat'"></h2>
