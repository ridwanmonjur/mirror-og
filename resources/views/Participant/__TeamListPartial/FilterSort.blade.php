<div class="d-flex justify-content-between w-70s align-items-center flex-wrap mt-2">
    ...
    <div id="filter-option" class="d-flex justify-content-start flex-wrap">
        <div class="dropdown me-3">
            ...
            >
                @foreach([['title' => 'Dota', 'value' => 'Dota'], ['title' => 'Dota 2', 'value' => 'Dota 2']] as $titleItem)
                    <div class="px-3 min-w-150px py-1">
                        <input onchange="setFilterForFetch(event, '{{$titleItem['title']}}');" type="checkbox" name="title" value="{{$titleItem['value']}}">
                        <label for="title">{{$titleItem['title']}}</label>
                    </div>
                @endforeach
            </div>
        </div>
        ...
        <div class="dropdown me-3">
            ...
            <div
                ...
                @foreach([['title' => 'Private', 'value' => 'Private'], ['title' => 'Public', 'value' => 'Public']] as $titleItem)
                    <div class="px-3 min-w-150px py-1">
                        <input onchange="setFilterForFetch(event, '{{$titleItem['title']}}');" type="checkbox" name="status" value="{{$titleItem['value']}}">
                        <label for="status">{{$titleItem['title']}}</label>
                    </div>
                @endforeach
            </div>
        </div>
