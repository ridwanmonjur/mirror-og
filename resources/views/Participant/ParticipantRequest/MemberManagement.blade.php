...
<div>
    <div class="tabs">
        <button id="PendingTeamBtn" class="tab-button inner-tab tab-button-active"
            onclick="showTab(event, 'PendingTeam', 'inner-tab')">
            Accept Team Requests
        </button>
        <button id="SentTeamBtn" class="tab-button inner-tab"
    ...
    <br>
    <div class="tab-content inner-tab" id="PendingTeam">
