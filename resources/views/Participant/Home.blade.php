    ...
    <nav>
        <div class="nav__sect1">
            ...
            <div class="search_box">
                ...
                <input class="nav__input" type="text" placeholder="Search for events" onchange="searchNavbar(event);">
            </div>
        </div>
        ...
        <div class="nav__items">
            <ul>
                ...
                <div class="dropdown">
                    <li><a onclick="myFunction()" style="color: white !important;" id='nav-but' class="dropbtn sign" data-toggle="dropdown" aria-expanded="false">Where's Moop?</a></li>
                </div>
