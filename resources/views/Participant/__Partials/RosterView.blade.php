            ...
            <div class="row mx-0 w-100" style="padding: 5px 10px;">
                <div class="col-6 col-xl-6 d-flex justify-content-start d my-1 px-0">
                    <a class="d-flex w-100 justify-content-start align-items-center"
                        ...
                        >
                        <span class="text-truncate d-inline-block w-75 text-start pe-2"> {{ $joinEvent->eventDetails->eventName }} </span>
                    </a>
                </div>
                ...
                <form onclick="event.stopPropagation(); " 
                    ...
                    @auth
                        @if ($user->role == 'PARTICIPANT')
                            <button type="submit" class="{{ 'followButton' . $joinEvent->eventDetails?->user_id }}" class="mx-auto "
