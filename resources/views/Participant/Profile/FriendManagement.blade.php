    ...
    @if ($user->id != $userProfile->id)
        ...
        @if ($friend && $user->role == "PARTICIPANT")
            @if ($friend->status == 'pending')
                @if ($friend->actor_id != $userProfile->id)
                    <span class="d-flex justify-content-start align-items-center mt-1">
                        <button
                            ...
                            style="font-size: 16px; font-weight: lighter; color: black;">
                ...
                @else
                    <span style="font-size: 16px; font-weight: lighter;" class="me-3 mt-1">
                    ...
                    <button type="button"
                        ...
                        class="btn border-danger text-red px-4 py-2 me-2 rounded-pill mt-1">
