                ...
                <div class="tab-content pb-4 modal-tab d-none" id="BackgroundColor">
                    <div>
                        ...
                        @foreach ([
                            ...
                            <div onclick="chooseColor(event, '{{ $color }}')" class="d-inline-block rounded color-pallete"
                        ...
                        @foreach ($colors as $colorGroup)
                            ...
                            @endphp
                            <div onclick="chooseGradient(event, '{{ $gradient }}')" class="d-inline-block rounded color-pallete"
