...
<div class="ms-3 d-flex flex-column justify-content-between position-relative popover__wrapper">
    <div class="mx-auto text-center popover__title">
     ...
     <div class="popover__content">
        ...
        <img alt="Joseph Francis Joey Tribbiani, Jr." src="https://media.giphy.com/media/11SIBu3s72Co8w/giphy.gif" width="20" heoigh="20">
    </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                ...
                <div class="text-center input-group w-75 mx-auto">
                    ...
                    <input
                        data-joinEventId="{{$joinEvent->id}}" data-total-amount="{{$total}}" data-existing-amount="{{$exisitngSum}}" data-modal-id="{{$random_int}}" 
                        name="amount" class="form-control" type="text" default="00.00" value="00.00" oninput="moveCursorToEnd(this); updateInput(this);" onkeydown="moveCursorToEnd(this); keydown(this); ">
                    <span 
                        data-joinEventId="{{$joinEvent->id}}" data-total-amount="{{$total}}" data-existing-amount="{{$exisitngSum}}" data-modal-id="{{$random_int}}" 
                        onclick="resetInput(this);" style="background-color: transparent;" class="input-group-text cursor-pointer border-0 button-close">
                        <svg 
                ...
                <br>
                <p class="text-center"><u>Selected Amount: RM <span class="putAmountClass">00.00 </span> </u></p>
                <br>
                <div class="mx-auto text-center">
