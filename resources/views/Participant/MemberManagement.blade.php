...
<body>
    ...
    <main class="main2">
        <div class="tabs">
            <button class="tab-button" onclick="showTab('CurrentMembers')">Current Members</button>
            <button class="tab-button" onclick="showTab('PendingMembers')">Pending Members</button>
        </div>
        ...
        <div class="tab-content" id="PendingMembers" data-type="member" style="text-align: center;">
