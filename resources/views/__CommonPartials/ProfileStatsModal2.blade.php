...
"                                                                   <div class="d-inline mx-0 px-0">
                                                            ...
                                                            <div x-cloak x-show.important="loggedUserRole == 'ORGANIZER' || user.role == 'ORGANIZER'" class="d-inline">
                                                                 <a :href="`/view/${user?.role?.toLowerCase()}/${user.id}`">
                                                                    <button x-cloak type="button"
                                                            ...
                                                            <div x-cloak x-show.important="user.logged_block_status" class="d-inline">
                                                                 <a :href="`/view/${user?.role?.toLowerCase()}/${user.id}`">
                                                                    <button x-cloak type="button"
                                                       ...
                                                       <li>
                                                        ...
                                                        <li>
                                                           <a class="dropdown-item ms-0 py-1 " href="#"
                                                                ...
                                                                x-bind:data-status="user.logged_block_status"
                                                                x-bind:data-inputs="user.id"
                                                           ...
                                                           >
                                                               ...
                                                               <span x-text=" user.logged_block_status ? 'Unblock Chat': 'Block Chat'">  </span>
                                                           </a>
                                                       </li> 
                                                       <li x-on:click="triggerReportSelection(event)" 
                                                            x-bind:data-user-id="user.id" 
                                                            x-bind:data-user-name="user.name" 
...
<div x-data="reportData">
    <div class="modal  "
        id="reportUserModal"
        tabindex="-1" >
        <div class="modal-dialog modal-lg mb-0" style="color: black !important;">
            <div class="modal-content  pt-3 pb-0 px-3">
                <div class="modal-body px-3 mx-3 pt-0 mt-0">
                    <div 
                        x-on:click="toggleWillShowReports"
                        class="mt-2 text-red ms-0 cursor-pointer"
                        x-show="!willShowReports"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                               class="bi bi-chevron-left" viewBox="0 0 16 16">
                               <path fill-rule="evenodd"
                    ...
                    <div x-cloak x-show="willShowReports" >
                        ...
                        <div class="d-flex justify-content-between mb-2"> 
                            <button 
                                class="btn btn-primary text-light px-3 mb-2 rounded-pill"
                                x-on:click="toggleWillShowReports"
                            >
                                <svg 
                            ...
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                class="bi bi-chevron-left d-inline" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd"
                                    d="M11.354 1.646a.5.5 0 0 1 0 .708L5.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0" />
                                </svg> 
                                <span> Go Back  </span>
                       ...
                       <template x-if="!reports?.[0]">
                        ...
                        <template x-for="(report, key) in reports" :key="report.id">
                            <div class="card mb-3">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h6 class="mb-0" x-text="'Report #' + (Number(key)+1)"></h6>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div class="text-end">
                                                ...
                                                <p class="mb-0" x-text="formatDate(report.created_at)"></p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <p class="mb-2 fw-medium" x-text="report.reason"></p>
                                        
                                        <small class="text-muted">Description</small>
                                        <p class="mb-0" x-text="report.description"></p>
                                    </div>
                                    ...
                                    {{-- <div class="mt-3 border-top pt-3">
                                        ...
                                        <p 
                                            ...
                                            x-text="report.admin_notes || 'No admin notes available'"
                                        ></p>
                                    </div> --}}
                                </div>
                                {{-- <div class="card-footer text-muted">
                                    <small x-text="'Last updated: ' + formatDate(report.updated_at)"></small>
                                </div> --}}
                            </div>
                        </template>
                    </div>
                    ...
                    <div x-cloak x-show="!willShowReports">
                        ...
                        <p style="color: gray;"><i> We are so sorry for your experience. Please let us know what we can do to help.</i> </p> 
                        
                        <form @submit.prevent="submitReport">
                            <div class="mb-3">
                                <p class="form-label text-red d-block">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="red" class="bi bi-exclamation-triangle ms-1 me-2" viewBox="0 0 16 16">
                            <path d="M7.938 2.016A.13.13 0 0 1 8.002 2a.13.13 0 0 1 .063.016.15.15 0 0 1 .054.057l6.857 11.667c.036.06.035.124.002.183a.2.2 0 0 1-.054.06.1.1 0 0 1-.066.017H1.146a.1.1 0 0 1-.066-.017.2.2 0 0 1-.054-.06.18.18 0 0 1 .002-.183L7.884 2.073a.15.15 0 0 1 .054-.057m1.044-.45a1.13 1.13 0 0 0-1.96 0L.165 13.233c-.457.778.091 1.767.98 1.767h13.713c.889 0 1.438-.99.98-1.767z"/>
                            <path d="M7.002 12a1 1 0 1 1 2 0 1 1 0 0 1-2 0M7.1 5.995a.905.905 0 1 1 1.8 0l-.35 3.507a.552.552 0 0 1-1.1 0z"/>
                            </svg>
                                Please mention your reason for reporting this user.</p>
                                ...
                                <div x-show="formData.reason === 'Other'" class="mt-2">
                                    <input 
                                        type="text" 
                                        class="form-control" 
                                        placeholder="Please specify the reason"
                                        x-model="formData.otherReason"
                                        :required="formData.reason === 'Other'"
                                    >
                                </div>
                                <div class="invalid-feedback" x-text="errors.reason"></div>
                            </div>

                            <div class="mb-3">
                                <p class="form-label text-red d-block">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="red" class="ms-1 me-2 bi bi-exclamation-octagon" viewBox="0 0 16 16">
                                <path d="M4.54.146A.5.5 0 0 1 4.893 0h6.214a.5.5 0 0 1 .353.146l4.394 4.394a.5.5 0 0 1 .146.353v6.214a.5.5 0 0 1-.146.353l-4.394 4.394a.5.5 0 0 1-.353.146H4.893a.5.5 0 0 1-.353-.146L.146 11.46A.5.5 0 0 1 0 11.107V4.893a.5.5 0 0 1 .146-.353zM5.1 1 1 5.1v5.8L5.1 15h5.8l4.1-4.1V5.1L10.9 1z"/>
                                <path d="M7.002 11a1 1 0 1 1 2 0 1 1 0 0 1-2 0M7.1 4.995a.905.905 0 1 1 1.8 0l-.35 3.507a.552.552 0 0 1-1.1 0z"/>
                                </svg>
                                Please explain your report in more detail.</p>
                                <textarea 
                                    class="form-control" 
                            ...
                            <div class="d-flex justify-content-center  my-4">
                                <button type="button" class="btn btn-secondary px-3 text-white rounded-pill me-4"  x-on:click="reset()" 
                                    data-bs-target="#connectionModal" data-bs-dismiss="modal"
                                    data-bs-toggle="modal"
                                >Cancel</button>
                                <button type="submit" class="btn btn-primary text-light px-3 rounded-pill" :disabled="loading">
