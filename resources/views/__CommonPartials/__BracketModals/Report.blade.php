                    ...
                    <div class="user-select-none popover-box row justify-content-start border border-dark border px-2 py-2"
                        ...
                        <div class="col-12 col-lg-4">
                            <div>
                                <img 
                                    ...
                                    height="100" onerror="this.src='{{ asset('assets/images/.png') }}';"
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="d-flex justify-content-center align-items-center h-100">
                                <h1 class="pe-4" x-text="report.teams[0].score"></h1>
                                <h1>-</h3>
                                <h1 class="ps-4" x-text="report.teams[1].score"></h1>
                            </div>
                        </div>
                        <div class="col-12 col-lg-4">
                            <div>
                        ...
                        <div class=" user-select-none row px-0 mx-auto">
                            <div class="col-1 col-xl-2 px-0 h-100 d-flex justify-content-center align-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" 
                                    x-bind:class="{ 'd-none': reportUI.matchNumber === 0 }"
                                    x-on:click="changeMatchNumber(-1) "
                            ...
                            <div class="col-10 col-xl-8 px-0">
                                <p>
                                    Game <span x-text="reportUI.matchNumber+1"> </span>
                                    <span class="text-success" x-text="report.matchStatus[reportUI.matchNumber]"></span> 
                                </p>
                            ...
                            <div class="col-1 col-xl-2 px-0 h-100 d-flex justify-content-center align-items-center">
                               <svg
                                ...
                                x-bind:class="{ 'd-none': reportUI.matchNumber === 2 }"
                                viewBox="0 0 16 16"
                            >
