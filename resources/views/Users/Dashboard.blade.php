...
@section('content')
    ...
    <main class=" "  v-scope="TransactionComponent()" class="row" @vue:mounted="init">
        ...
        <div class="row my-2 px-5 py-2">
            <h2 class="col-12 col-md-6 my-2 py-0 text-start fw-semibold">My Wallet</h2>
            <h5
                style="z-index: 99;"
                id="main-nav" onclick="openTab('wallet-main');" class="cursor-pointer my-2 d-none py-0 position-relative col-12 col-md-6 text-start text-md-end fw-medium">
            ...
            <div class="col-12 px-0 col-xl-5">
                <div class="card my-2 mx-2 py-0 border border-3 border-primary  rounded-30px ">
                    <div class="card-body d-flex flex-column justify-content-center">
                        <h5 class="my-3 text-gray-dark fw-medium">Current Balance </h5>
                        <h2 class="text-primary my-3 fw-bold"> RM  {{ number_format($wallet->current_balance, 2) }} </h2>
                        <div class="my-2">
                            <button type="button"
                                class="btn d-inline-block me-2 my-1 rounded-pill btn-primary  text-light fw-medium"
                            ...
                            <button type="button" class="btn rounded-pill my-1 btn-secondary text-light fw-medium"
                ...
                <div class="card my-2  mx-2 py-1 border border-2 border-secondary rounded-30px">
                    <div class="card-body">
                        <div class="row text-gray-dark">
                            <p class="col-6 text-start fw-medium fs-6 mb-2">Coupons expiring soon</p>
                            {{-- ahref --}}
                            <a href="{{route('wallet.coupons')}}" class="col-6 text-end cursor-pointer">
                                <span class="text-gray-dark fw-medium">View all my coupons</span>
                                <span>
                        ...
                        <div class="container-fluid px-0 py-0">
                            <div class="transaction-history">
                                <div class="row py-0 px-3 my-0">
                                    <h4 class="transaction-history__title  col-12 col-lg-6 text-gray-dark fw-semibold mb-3">Most recent transactions
                                    </h4>
                                    <a href="{{route('wallet.transactions')}}" class="col-12 col-lg-6 text-gray-dark text-start text-lg-end fw-medium">
                                ...
                                <div class="table-responsive my-2">
                                    <table class="transaction-history__table table "
                                        ...
                                        <thead class="transaction-table__header">
                                            <tr>
                                                <th scope="col"
                                                    class="transaction-table__header-cell bg-secondary text-white py-3 fw-semibold">Date
                                                </th>
                                                <th scope="col"
                                                    class="transaction-table__header-cell bg-secondary text-white py-3 fw-semibold">
                                                    Transaction</th>
                                                <th scope="col"
                                                    class="transaction-table__header-cell bg-secondary text-white py-3 fw-semibold">Type
                                                </th>
                                                <th scope="col"
                                                    class="transaction-table__header-cell bg-secondary text-white py-3 fw-semibold">
                                                    Total
                ...
                <div class="card-body px-2 py-2">
                    <div class=" px-2 py-2">
                        <div class=" px-1 py-0 my-0">
                            <h4 class="text-center mt-2 mb-3 text-gray-dark fw-semibold">Add funds to your wallet</h4>

                        </div>
                        <div class="mt-3">
                            <div class="text-center mx-auto my-3 py-3 text-light bg-primary rounded-30px"
                                style="width: min(300px, 80%);">
                                <h5 class="mt-1 mb-3 fw-medium">Current Wallet Balance </h5>
                                <h2 class=" my-3 fw-bold"> RM  {{ number_format($wallet->current_balance, 2) }} </h2>
                            </div>
                            ...
                            <div class="my-2">
                                <form action="{{ route('wallet.checkout') }}" method="POST">
                                    ...
                                    <div class="text-center mb-4">
                                        <label for="topup_amount" class="fw-medium mb-2">Please enter an amount to add </label>
                                        ...
                                        <small class="text-muted fst-italic lh-sm">Minimum amount is RM  5.00</small>
                                    </div>
                                    <div class="d-flex justify-content-around w-75 my-4 mx-auto">
                                        <button onclick="fillInput('topup_amount', 10)" type="button"
                                            class="btn BG-secondary text-light rounded-pill fw-medium">
                                            10 RM
                                        </button>
                                    ...
                                    <div class="d-flex justify-content-around w-75 mb-4 mx-auto">
                                        <button onclick="openTab('wallet-main')" type="button"
                                            class="btn border-secondary text-dark rounded-pill px-4 py-2 fw-medium">
                                            Cancel
                                        </button>

                                        <button type="submit"
                                            class="btn btn-primary  text-light rounded-pill px-4 py-2 fw-medium">Next</button>
        ...
        <div class="d-none mx-auto px-0 container-main " id="wallet-withdraw-fund">
            <div class="card px-0 py-0 border border-2 mx-auto border-secondary my-0 w-95-lg-50 rounded-30px">
                <div class="card-body px-2 py-2">
                    <div class=" px-2 py-1">
                        <div class=" px-1 py-0 my-0">
                            <h4 class="text-center mt-2 mb-3 text-gray-dark fw-semibold">Withdraw funds from your wallet</h4>

                        </div>
                        <div class="mt-3">
                            <div class="text-center mx-auto my-2 py-2 text-light bg-secondary rounded-30px"
                                style="width: min(300px, 80%);">
                                <h5 class="my-1  fw-medium">Current Wallet Balance </h5>
                                <h4 class=" my-1 fw-bold"> RM  {{ number_format($wallet->current_balance, 2) }} </h4>
                            </div>
                            ...
                            <div class="text-center mx-auto my-2 py-2 text-light bg-primary rounded-30px"
                                style="width: min(300px, 80%);">
                                <h5 class="my-1  fw-medium">New Wallet Balance </h5>
                                <h4 class=" my-1 fw-bold"> RM  {{ number_format($wallet->current_balance, 2) }} </h4>
                            </div>
                            ...
                            <div class="my-2">
                                <form id="withdrawal-form" action="{{ route('wallet.withdraw') }}" method="POST">
                                    @csrf
                                    <div class="text-center mb-4">
                                        <label for="topup_amount" class="fw-medium mb-2">Please enter your amount to withdraw </label>
                                        <div class=" input-group  d-flex justify-content-center mx-auto ">
                                            <button class="btn mx-auto pe-none btn-outline-secondary my-2 me-0 py-0"
                                                type="button" id="button-addon1">RM  </button>
                                            <input type="number" id="topup_amount" name="topup_amount"
                                        ...
                                        @if ($wallet->has_bank_account)
                                            <div class="text-center text-primary fst-italic mt-1 mb-2 lh-sm">Linked bank account: {{$wallet->bank_name}} **** {{$wallet->bank_last4}}</div>
                                        @else
                                            <div class="text-center mt-1 mb-2 fw-medium">No linked bank account</div>
                                        @endif
                                    </div>
                                    <div class="d-flex justify-content-around w-75 mt-2 mb-4 mx-auto">
                                        ...
                                        <button type="submit"
                                            class="btn btn-primary withdraw-button text-light rounded-pill px-4 py-2 fw-medium">Yes, request withdrawal</button>
                                    </div>
                                    <small class="fst-italic text-primary w-75 d-block text-center mx-auto lh-sm">
        ...
        <div class="d-none mx-auto px-0 container-main min-h-85vh" id="wallet-view-coupons">
            <div class="center-container mx-auto">
                <div class="card px-3 py-2 border border-2 mx-auto border-secondary  min-w-95vw rounded-30px">
                    <div class="card-body px-2 py-2">
                        <div class="row ">
                            <h3 class="col-6 text-start transaction-history__title fw-semibold">My Coupons</h3>
                            <div class="col-6 text-end">
                                <a type="button"
                                    href="{{route('wallet.coupons', ['empty' => 1 ]) }}"
                                    class="btn rounded-pill border-dark text-dark fw-medium">
                                    <span>
