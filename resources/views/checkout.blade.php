  ...
  <div class="col">
    ...
    <div class="ORDER DETAILS">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <img src="{{ productImage($item->product->image) }}" alt="item" class="img_cartpage">
                </div>
                <div class="col-lg-7">
                    <a href="{{route('shop.show', $item->product->slug)}}" style="color: black;"> {{$item->product->name}}</a>
                    <p>${{ $item->product->price }}</p>
                    
                <p class="cart_p">COLOR: Black <br>
                   SIZE: 9.5  / Quantity: {{ $item->quantity }}  </p>
                </div>
            </div>
        </div>
        @endforeach
