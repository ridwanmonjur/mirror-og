                        ...
                        <div>
                            ...
                            <div>
                                <div>
                                    ...
                                    &nbsp;
                                    @if($event->tier)
                                    <span style="position: relative; top: 5px;"> RM {{ $event->tier->tierPrizePool ?? 'No Prize' }} Prize Pool</span>
                                    @else
                                ...
                                <div>
                                    ...
                                    &nbsp;
                                    @if($event->tier)
                                    <span style="position: relative; top: 5px;">RM {{ $event->tier->tierEntryFee ?? 'Free' }} Entry Fees</span>
                                    @else
                                ...
                                <div>
                                    ...
                                    &nbsp;
                                    @if($event->tier)
                                    <span style="position: relative; top: 5px;"> /{{ $event->tier->tierTeamSlot ?? 'Not Available'}}</span>
                                    @else
