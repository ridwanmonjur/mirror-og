        ...
        <section class="time-line-box">
            ...
            <div id="step-1" class="d-none">
                <header class="welcome text-center">
                    ...
                    <p>First, select an esport title</p>
                    <br>
                    <div class="image-scroll-container" id="imageContainer">
                        <div class="scroll-images">
                            <a href="#">
                                <img class="selectable-image" src="{{ asset('/assets/images/createEvent/dotaPoster.jpg') }}" alt="" style="border-radius: 20px; height: 330px; width: 220px;">
                            </a>
                            <h5 style="padding-top: 10px;">Dota 2</h5>
                        </div>
                        <div class="scroll-images">
                            <a href="#">
                                <img class="selectable-image" src="{{ asset('/assets/images/createEvent/valoPoster.jpg') }}" alt="" style="border-radius: 20px; height: 330px; width: 220px;">
                            </a>
                            <h5 style="padding-top: 10px;">Valorant</h5>
                        </div>
                        <div class="scroll-images">
                            <a href="#">
                                <img class="selectable-image" src="{{ asset('/assets/images/createEvent/fc24Poster.jpg') }}" alt="" style="border-radius: 20px; height: 330px; width: 220px;">
                            </a>
                            <h5 style="padding-top: 10px;">FC24</h5>
                        </div>
                    </div>
                </header>
                <div class="flexbox box-width">
            ...
            <div id="step-2" class="d-none">
                ...
                <div class="cont">
                    <a href="#" class="box_2nd selectable-box" onclick="toggleSelection(this)">
            ...
            <div id="step-3" class="d-none">
                ...
                <section class="featured-events">
                    <a href="#" class="event selectable-box" onclick="toggleSelection(this)">
                        <div class="event_head_container">
                    ...
                    <a href="#" class="event_1 selectable-box" onclick="toggleSelection(this)">
                        <div class="event_head_container">
                    ...
                    <a href="#" class="event_2 selectable-box" onclick="toggleSelection(this)">
                        <div class="event_head_container">
