            ...
            <div>
                ...
                <div style="color: #2F4A58;">
                    ...
                    <div class="d-flex justify-content-center">
                        @if ($status!= "DRAFT" && $event->sub_action_private == "private" && !in_array($status, ['PENDING', 'ENDED'])) 
                            <a class="m-0 mt-2 px-3 py-2 oceans-gaming-default-button text-light" href="{{ route('event.invitation.index', $event->id) }}">
