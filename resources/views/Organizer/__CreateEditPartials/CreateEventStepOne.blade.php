    ...
    <div class="welcome text-center" >
        ...
        <div class="image-scroll-container box-width py-2">
            ...
            <div class="scroll-images  " onclick="
                ...
                ">
                <a href="#">
                    <img class="border border-dark selectable-image" src="<?php echo asset("storage/$category->gameIcon"); ?>" alt="" style="object-fit: cover; border-radius: 20px; height: 325px; width: 220px;"></a>
