            ...
            <div class="form-group col-12 col-lg-6 mx-auto">
                ...
                <div class="mx-auto d-flex justify-content-center  ">
                    <input type="text" id="timerange-display" class="ps-3 rounded-pill dropdown" readonly
                         data-bs-toggle="dropdown" data-bs-auto-close="manual"
                    >
                    ...
                    <div class="dropdown-menu p-3" style="width: min(400px, 90vw);">
                        <div class="box">
                            <div class="small-detail" style="font-weight: bold;"><b>Start</b></div>
                        ...
                        <div class="mt-2">
                            <button class="btn rounded-pill btn-primary text-light" type="button" onclick="closeDropDown()">Close</button>
                        </div>
                    </div>
                </div>
            </div>
