...
<body>
    ...
    <main>
        ...
        <div class="">
            ...
            <div class="d-none"> 
                <div class="icon2 d-inline me-2 mt-2 asc-sort-icon cursor-pointer" 
                ...
                <div class="icon2 d-inline me-2 mt-2 desc-sort-icon cursor-pointer" 
                    onclick="toggleDropdown('dropdownSortButton'); setFetchSortType(event);"
                >
                ...
                <div class="icon2 d-inline me-2 mt-2 none-sort-icon cursor-pointer" 
                    onclick="toggleDropdown('dropdownSortButton'); setFetchSortType(event);"
                >
