...
<body>
    ...
    >
        ...
        <div>
            ...
            > 
                 <div class="d-flex justify-content-end py-0 my-0 mb-2">
                    <button 
                     data-bs-toggle="offcanvas"
                        ...
                        class="editMode d-none btn btn-secondary text-light rounded-pill py-2 me-3 fs-7"
                    > 
                        Change Background
                    </button>
                </div>
                        ...
                        <label  class="upload-label">
                            <div class="circle-container">
                                ...
                                <div class="d-flex align-items-center justify-content-center upload-button pt-3">
                                    ...
                                    @if ($isUserSame)
                                        <button  id="upload-button2" class="editMode d-none btn btn-sm p-0" aria-hidden="true">
                ...
                <div class="member-details mx-auto text-center">
                    <div class="pb-3 editMode d-none">
                        ...
                        <button 
                            ...
                            class="mt-2 oceans-gaming-default-button simple-button cursor-pointer bg-success btn-success btn text-dark px-3 py-1 me-2 text-success"> 
                            Save
                        </button>
                        <svg 
                        {{-- Close icon --}}
                        onclick="turnOffEditMode()"
                        xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="mt-2 py-1 bi bi-x-circle cursor-pointer text-red" viewBox="0 0 16 16">
                        <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/>
                        <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708"/>
                        </svg>
                        <br>
                    </div>
                    <div class="notEditMode">
                        <h5>
                            {{$userProfile->name}}
                        </h5>
                        <p> 
                        ...
                        @if ($isOwnProfile)
                            <div class="text-center">
                                <button 
                                    ...
                                    {{-- x-on:click="reset(); turnOnEditMode()" --}}
        ...
        <div class="tabs px-5 notEditMode" >
        ...
        <div class="tab-content notEditMode pb-4 outer-tab px-5" id="Overview">
            <br> 
        ...
        <div class="notEditMode tab-content pb-4  outer-tab d-none" id="Events">
            <br>
            ...
            @else
                <div id="activeRostersForm" class="text-center mx-auto">
                    <br>
        ...
        <form data-url="{{route('organizer.profile.update')}}" id="updateProfileForm" onsubmit="submitEditProfile(event);" method="POST">  
        <input type="hidden" name="userProfile[id]" value="{{$userProfile->id}}">
        <input type="hidden" name="organizer[id]" value="{{$userProfile?->organizer?->id}}">
        <input type="hidden" name="address[id]" value="{{$userProfile?->address?->id}}">
        ...
        <div class="grid-2-columns tab-size">
            <div class="">
                ...
                <div> About </div>
                <br>
                <div  class="pe-5 editMode d-none">
                    <textarea 
                    ...
                    >
                        @foreach([
                            ...
                            <option
                                ...
                                value="{{$industry}}"
                                {{ $userProfile?->organizer?->industry ? 'selected' : '' }}
                            >{{$industry}}
                            </option> 
                        @endforeach
                    </select> 
                ...
                <div class="notEditMode">
                    <!-- Company Description -->
                    <p class="organizer-description d-none"></p>

                    <!-- Industry and Type -->
                    <p class="mt-2 d-none industry-type-container">
                        <span class="me-5 organizer-industry d-none"></span>
                        <span class="organizer-type d-none">ℹ <span class="type-text"></span></span>
                    </p>

                    <!-- Address -->
                    <p class="mt-2 d-none address-container">
                        ...
                        <span class="address-line1 d-none"></span>
                        <span class="address-line2 d-none"></span><br>
                        <span class="address-city d-none ms-4"></span><br>
                        <span class="address-country d-none ms-4"></span>
                    </p>

                    <!-- Phone Number -->
                    <p class="mt-2 d-none phone-container">
            ...
            <div class="">
                ...
                <div> Links </div>
                <br>
                <div class="editMode d-none" class="pe-4">
                ...
                <div class="notEditMode">
                    ...
                    <p class="mt-2 d-none organizer-website social-link-container">
                    ...
                    <p class="mt-2 d-none organizer-facebook social-link-container">
                    ...
                    <p class="mt-2 d-none organizer-instagram social-link-container">
                    ...
                    <p class="mt-2 d-none organizer-twitter social-link-container">
                        <svg width="25px" height="25px" class="me-3 cursor-pointer"  viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M11.7887 28C8.55374 28 5.53817 27.0591 3 25.4356C5.15499 25.5751 8.95807 25.2411 11.3236 22.9848C7.76508 22.8215 6.16026 20.0923 5.95094 18.926C6.25329 19.0426 7.6953 19.1826 8.50934 18.856C4.4159 17.8296 3.78793 14.2373 3.92748 13.141C4.695 13.6775 5.99745 13.8641 6.50913 13.8174C2.69479 11.0882 4.06703 6.98276 4.74151 6.09635C7.47882 9.88867 11.5812 12.0186 16.6564 12.137C16.5607 11.7174 16.5102 11.2804 16.5102 10.8316C16.5102 7.61092 19.1134 5 22.3247 5C24.0025 5 25.5144 5.71275 26.5757 6.85284C27.6969 6.59011 29.3843 5.97507 30.2092 5.4432C29.7934 6.93611 28.4989 8.18149 27.7159 8.64308C27.7224 8.65878 27.7095 8.62731 27.7159 8.64308C28.4037 8.53904 30.2648 8.18137 31 7.68256C30.6364 8.52125 29.264 9.91573 28.1377 10.6964C28.3473 19.9381 21.2765 28 11.7887 28Z" fill="#47ACDF"></path> </g></svg>
                        <span class="social-link-text"></span>
                    </p>
                </div>
