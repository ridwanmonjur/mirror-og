                        ...
                        <label for="image-upload" class="upload-label">
                            <div class="circle-container">
                                ...
                                <div class="d-flex align-items-center justify-content-center upload-button pt-3">
                                    <a aria-hidden="true" data-fslightbox="gallery" href="{{ '/' . 'storage/' . $userProfile->userBanner }}">
                                    ...
                                    @if ($isUserSame)
                                        <button x-cloak x-show="isEditMode" id="upload-button" class="btn btn-sm p-0" aria-hidden="true">
