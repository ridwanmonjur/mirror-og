...
<body style="margin:0;padding:0;">
    ...
    <td align="start" style="padding: 20px 0 10px 20px;">
                            <img src="{{$message->embed(public_path('assets/images/DW_LOGO.png'))}}" alt="" width="250"
                                    style="height:auto;display:block;" />
                            {{-- <img src="{{ asset('assets/images/DW_LOGO.png') }}" alt="" width="300"
                                style="height:auto;display:block;" /> --}}
                        </td>
