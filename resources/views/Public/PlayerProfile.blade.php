...
<body>
    ...
    <div data-user-profile-id="{{ $userProfile->id }}"
        ...
        data-background-styles="{{ $backgroundStyles }}" data-font-styles="{{ $fontStyles }}"
    ...
    <main id="app">
        ...
        <div class="tab-content pb-4  outer-tab" id="Overview">
            ...
            <div class="d-flex d-none d-lg-flex justify-content-center font-poppins text-lg text-primary-dark">Recent Events</div>
            ...
            <div class="position-relative d-none d-lg-flex justify-content-center">
                ...
                @else
                    ...
                    <button class="carousel-button position-absolute " style="right: 30px;" onclick="carouselWork(2)">
                        &gt;
                    </button>
                    <div @class([
                        'event-carousel-works animation-container ',
            ...
            <div class="row px-4 mt-4">
                <div class="row px-4 ">
                        ...
                        <div class="card border-2 py-0 my-0 mx-auto py-4" style=" width: 90%;">
                            <div class="card-body row py-2 d-flex justify-content-center flex-wrap text-center mx-auto py-0 px-0 "
                                ...
                                <div class="col-12 col-xl-4">
                                    ...
                                    <p class="mx-2 py-2 my-0 fw-semibold"> Event{{ bldPlural($totalEventsCount) }} Joined
                                        By Player </p>
                                </div>
                                <div class="col-12 col-xl-4">
                                    <h3 class="py-0 my-0"> {{ $wins }} </h3>
                                    <p class="mx-2 py-2 my-0 fw-semibold"> Tournament Win{{ bldPlural($wins) }} By Player
                                    </p>
                                </div>
                                <div class="col-12 col-xl-4">
                                    <h3 class="py-0 my-0"> {{ $streak }} </h3>
                                    <p class="mx-2 py-2 my-0 fw-semibold"> Player Current Win Streak </p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="achievements col-12 col-lg-6">
                        <div class="ms-2 text-center font-poppins text-lg text-primary-dark">Positions</div><br>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between my-2">
                                            <div class="d-flex align-items-center flex-grow-1">
                                                <img src="{{ '/storage' . '/' . $team->teamBanner }}"
                                                    ...
                                                    alt="{{ $team->teamName }}">
                                                <div>
                                                    <h5 class="card-title mb-0 font-poppins text-lg text-primary-dark">{{ $team->teamName }}</h5>
                                                    <div>
