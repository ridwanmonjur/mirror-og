        ...
        <div class="card-text">
            ...
            <div class="">
                ...
                <div>
                    ...
                    @else
                        <div class="text-center">
                            <p class="my-0 py-0"> 
                                <span class="{{ ' Color-' . $event->tier?->eventTier }}">Choose a start date</span>
                            </p>
                        </div>
                    @endif
                </div>
            ...
            <div class="group-hover flex-wrap d-flex justify-content-center cursor-pointer mb-1">
                    ...
                    @if (in_array($status, ['UPCOMING', 'DRAFT', 'SCHEDULED']))
                        ...
                        @if ($status !== 'ONGOING')
                            <a class="m-0 mb-1 mx-4 p-0"  href="{{ route('event.edit', $event->id) }}">
                    ...
                    @elseif ($status === "PENDING")
                        <a class="m-0 mx-4 mb-1 p-0"  href="{{ route('organizer.checkout.view', $event->id) }}">
                        ...
                        <a class="m-0 mx-4 mb-1 p-0"  href="{{ route('event.edit', $event->id) }}">
                            <svg onclick="goToEditScreen()" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
                            <path d="M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.5.5 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11z"/>
                            </svg>
                        </a>
