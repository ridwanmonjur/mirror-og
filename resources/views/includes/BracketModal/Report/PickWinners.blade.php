<div class="my-0 py-0">
    <button v-on:click="selectTeamToWin(event, 0)" v-bind:disabled="reportUI.disabled"
    ...
    <button v-on:click="selectTeamToWin(event, 1)" :disabled="reportUI.disabled"
        ...
        <p  
            ...
            reportUI.disabled ? 'text-secondary' :  'text-primary'
            ]"   
        >   
        </p>
