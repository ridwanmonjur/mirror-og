            ...
            <div class="{{ 'col-12 text-center pt-0 pb-2 px-0 ' . 'Team1' . ' ' . 'Team2' }}">
                <div class="row justify-content-start bg-light border border-3 border rounded px-2 py-2">
                    ...
                    <div class="ps-5 ps-5 text-start">
                        <div class="mt-2">
                            <div>
                                <img v-bind:src="'/storage/' + report.teams[report.realWinners]?.banner"
                            ...
                            <div class="mt-2 mb-2 d-block">
                                <p>
                                    <span v-text="report.teams[report.realWinners]?.name"> </span>
                                    has been resolved as the winner.
                                </p>
                                <template
                                    v-if="dispute && dispute?.resolution_resolved_by">
                                    <div class="my-0 py-0">
                                    <template
                                        v-if="
                                    ...
                                    <template
                                        v-else-if="dispute?.resolution_resolved_by == disputeLevelEnums['ORGANIZER']">
                                        <div class="mt-2">
                                            <p class="text-success mt-2">
                                    ...
                                    <template v-else-if="dispute?.resolution_resolved_by == disputeLevelEnums['TIME'] ">
                                        <div class="mt-2">
                                            <p class="text-success mt-2">
                                ...
                                <template
                                    v-if="userLevelEnums['IS_ORGANIZER'] == report.userLevel && dispute">
                                    <div class="d-inline">
