    ...
    <div class="{{ 'col-12 text-center pt-0 pb-2 px-0 ' . 'Team1' . ' ' . 'Team2' }}">
        <div class="row justify-content-start bg-light border border-3 border-dark border rounded px-2 py-2">
            ...
            <div class="ps-5 ps-5 text-start">
                ...
                <img v-bind:src="'/storage/' + report.teams[dispute?.dispute_teamNumber]?.banner"
                ...
                <p class="text-primary">
                    ...
                    <span v-show="reportUI.teamNumber == dispute?.dispute_teamNumber">(Your
                        Team)</span>
                </p>

                <p class="my-0" v-html="dispute?.dispute_reason">
                </p>
