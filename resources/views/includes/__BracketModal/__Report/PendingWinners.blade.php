<div class="my-0 py-0"> 
<template v-if="report.disqualified && report.disqualified[reportUI.matchNumber]">
    <div>
        <div>
            <svg width="50" height="50" class="border border-dark border-2 rounded-circle py-1" viewBox="0 0 50 50"
            ...
            <div>
                <small v-if="reportUI.matchNumber == 0">
    ...
    <template v-else>
        <div>
            <div>
                <svg class="border border-dark border-2 rounded-circle py-1" fill="#2e4b59" version="1.1"
                    id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    width="64px" height="64px" viewBox="0 0 973.1 973.1" xml:space="preserve" stroke="#2e4b59"
                    stroke-width="15.5696">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC"
                        stroke-width="7.7848"></g>
