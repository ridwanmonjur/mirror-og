                ...
                <div v-cloak class="circle-container motion-logo">
                    ...
                    <div class="d-flex align-items-center justify-content-center upload-button pt-3">
                        <a class="cursor-pointer" aria-hidden="true" data-fslightbox="lightbox"
                            ...
                            <button class="btn btn-sm simple-button p-0 "><svg xmlns="http://www.w3.org/2000/svg" width="20"
                        ...
                        @if ($isUserSame)
                            <button v-show="isEditMode" id="upload-button2" class="btn btn-sm mx-2 simple-button p-0 z-99"
                                aria-hidden="true">
                            ...
                            <button v-if="isEditMode" id="trash-button3" v-on:click="removeProfile(event);" class="btn btn-sm simple-button  p-0 z-99"
                                aria-hidden="true">
