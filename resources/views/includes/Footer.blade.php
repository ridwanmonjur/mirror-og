<footer class=" text-light fw-bold pt-4 pb-2 " style=" background-color: rgb(15, 23, 42, 0.6);">
    <div class="container">
        <div class="row g-4">
            <!-- About Section -->
            ...
            <div class="col-12 col-xxl-2">
                <div>
                    ...
                    <div class="d-flex justify-content-center text-center my-2 gap-3">
                        ...
                        <a href="https://discord.gg/driftwood" target="_blank" rel="noopener noreferrer"
                            class="text-light fw-bold" aria-label="Discord">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                                viewBox="0 0 16 16">
                                <path
