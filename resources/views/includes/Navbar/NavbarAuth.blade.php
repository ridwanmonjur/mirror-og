...
>
                    ...
                    <template v-for="notification in notificationList" v-bind:key="notification.id">
                        <div 
                            ...
                            v-on:click="markNotificationRead( notification.id, notification.link, notification.is_read)"
                        >
                            ...
                            <div class="notification-icon " style="white-space: nowrap;">
                                ...
                                <template v-else-if="notification.img_src">
                                    <img v-bind:src="'/storage/' + notification.img_src" class="rounded-circle border object-fit-cover me-3" width="30"
                                        height="30" alt="Profile"
                                        onerror="this.src='{{ asset('assets/images/404q.png') }}';"
                                    >
                                </template>
                                <template v-else>
                                    <img src="{{ asset('assets/images/404q.png') }}" class="rounded-circle object-fit-cover me-3 border border-secondary" width="30"
                                        height="30" alt="Profile"
                                    >
                                </template>
                            </div>
    ...
    <div class="dropdown-menu border shadow-lg px-2 py-0 dropdown-menu-end" style=" border-radius: 10px; top: 120%; font-size: 14px; width: 250px;"
        ...
        @if ($user->role == 'ORGANIZER')
            <a class="dropdown-item py-navbar  ps-4 align-middle " href="{{ route('organizer.profile.view') }}">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#808080"
            ...
            <a class="dropdown-item py-navbar my-0  ps-4 align-middle " href="{{ route('event.create') }}">
               <svg version="1.1" class="me-3" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32" enable-background="new 0 0 32 32" xml:space="preserve" 
                    width="20" height="20" fill="#808080"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <polygon points="22,16.8 22,26 6,26 6,10 15.2,10 17.2,8 4,8 4,28 24,28 24,14.8 "></polygon> <path fill="none" stroke="#808080" stroke-width="2" stroke-miterlimit="10" d="M16.5,18.3L13,19l0.7-3.5l9.9-9.9 c0.8-0.8,2-0.8,2.8,0l0,0c0.8,0.8,0.8,2,0,2.8L16.5,18.3z"></path> </g></svg>
               <span>Create</span>
            </a>
            ...
            <a class="dropdown-item py-navbar  ps-4 align-middle " href="{{ route('shop.index') }}">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#808080"
                    class="bi bi-shop me-3" viewBox="0 0 16 16">
        ...
        @if ($user->role == 'PARTICIPANT' )
            ...
            <a class="dropdown-item  py-navbar my-0  ps-4 align-middle " href="{{ url('/participant/team/list/') }}">
               <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#808080" class="bi bi-trophy me-3" viewBox="0 0 16 16">
            ...
            <a class="dropdown-item py-navbar my-0  ps-4 align-middle " href="{{ route('shop.index') }}">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#808080"
                    class="bi bi-shop me-3" viewBox="0 0 16 16">
                    <path d="M2.97 1.35A1 1 0 0 1 3.73 1h8.54a1 1 0 0 1 .76.35l2.609 3.044A1.5 1.5 0 0 1 16 5.37v.255a2.375 2.375 0 0 1-4.25 1.458A2.37 2.37 0 0 1 9.875 8 2.37 2.37 0 0 1 8 7.083 2.37 2.37 0 0 1 6.125 8a2.37 2.37 0 0 1-1.875-.917A2.375 2.375 0 0 1 0 5.625V5.37a1.5 1.5 0 0 1 .361-.976zm1.78 4.275a1.375 1.375 0 0 0 2.75 0 .5.5 0 0 1 1 0 1.375 1.375 0 0 0 2.75 0 .5.5 0 0 1 1 0 1.375 1.375 0 1 0 2.75 0V5.37a.5.5 0 0 0-.12-.325L12.27 2H3.73L1.12 5.045A.5.5 0 0 0 1 5.37v.255a1.375 1.375 0 0 0 2.75 0 .5.5 0 0 1 1 0M1.5 8.5A.5.5 0 0 1 2 9v6h1v-5a1 1 0 0 1 1-1h3a1 1 0 0 1 1 1v5h6V9a.5.5 0 0 1 1 0v6h.5a.5.5 0 0 1 0 1H.5a.5.5 0 0 1 0-1H1V9a.5.5 0 0 1 .5-.5M4 15h3v-5H4zm5-5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1zm3 0h-2v3h2z"/>
                </svg>
            ...
            <a class="dropdown-item py-navbar my-0  ps-4 align-middle " href="{{ route('cart.index') }}">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#808080"
                    class="bi bi-cart me-3" viewBox="0 0 16 16">
                    <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5M3.102 4l1.313 7h8.17l1.313-7zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4m7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4m-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2m7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2"/>
                </svg>
                Cart
            </a>
            <a class="dropdown-item py-navbar my-0  ps-4 align-middle " href="{{ route('orders.index') }}">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#808080"
                    class="bi bi-bag-check me-3" viewBox="0 0 16 16">
        ...
        @endif
        @if ($user->role == 'ADMIN' )
            <a class="dropdown-item py-navbar my-0  ps-4 align-middle " href="/admin">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#808080"
                    class="bi bi-person-circle me-3" viewBox="0 0 16 16">
                    <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0" />
                    <path fill-rule="evenodd"
