...
<div class="position-relative">
 ...
 >
     ...
     <tbody class="tournament-bracket__content">
         <tr class="tournament-bracketTeam  px-2 py-3 bg-special  tournament-bracketTeam--winner ">
             ...
             <td class="tournament-bracket__pos d-flex align-items-center my-2 flex-nowrap justify-content-end">
                ...
                @else
                    <img  
                        ...
                        class="object-fit-cover mobile-img border  team rounded-circle me-2" alt="Team View"
                    >
                 @endif
                    <svg 
                        data-position="{{$bracket['team1_position']}}" 
             ...
             <td class="d-inline-block ">
                 @if ($bracket['team1_id'])
                    <abbr title="{{ $bracket['team1_teamName'] }}" class=" me-auto text-muted fw-bold">{{$bracket['team1_teamName']}}</abbr>
                @else
                    <abbr class=" me-auto text-muted fw-bold">TBD</abbr>
                @endif
             </td>
         </tr>
         <tr class="tournament-bracketTeam  bg-special px-2 py-3 ">
             ...
             <td class="tournament-bracket__pos d-flex align-items-center my-2  flex-nowrap justify-content-start">
                 ...
                 @else
                    <img  
                        ...
                        width="40" height= "40"
                        src="{{asset('assets/images/404.svg')}}" 
                        class="object-fit-cover me-2 mobile-img border  team rounded-circle" alt="Team View"
                    >
                @endif
            ...
            <td class="d-inline-block ">
                 @if ($bracket['team2_id'])
                    <abbr title="{{ $bracket['team2_teamName'] }}"  class="ms-auto text-muted fw-bold">{{$bracket['team2_teamName']}}</abbr>
                @else
                    <abbr class="ms-auto text-muted fw-bold">TBD</abbr>
                @endif
             </td>
         </tr>
    ...
    @if($bracket['user_level'] === $USER_ACCESS['IS_ORGANIZER'])
        <span class="h-100">
            <svg 
                ...
                onclick="currentMatchUpdateShow(event); " style="z-index: 9;"
